...
TAXONOMIES = {
    ...
    "industry": {
        ...
        "values": {
            ...
            "telecommunications": {"description": "Telecommunications"},
            "media": {"description": "Media"},
            "entertainment": {"description": "Entertainment"},
            "food": {"description": "Food & Beverage"},
            "construction": {"description": "Construction"},
            "agriculture": {"description": "Agriculture"},
            "pharmaceuticals": {"description": "Pharmaceuticals"},
    ...
    "job_role": {
        ...
        "values": {
            ...
            "ceo": {"description": "CEO"},
            "coo": {"description": "COO"},
            "product_manager": {"description": "Product Manager"},
            "project_manager": {"description": "Project Manager"},
            "data_scientist": {"description": "Data Scientist"},
            "devops": {"description": "DevOps"},
            "security": {"description": "Security professional"},
        }
    },
    "protocol": {
        "name": "Protocol",
        ...
        "values": {
            ...
            "https": {"description": "HTTPS"},
            "websocket": {"description": "WebSocket"},
            "grpc": {"description": "gRPC"},
            "mqtt": {"description": "MQTT"},
            "amqp": {"description": "AMQP"},
            "stomp": {"description": "STOMP"},
            "websocket": {"description": "WebSocket"},
            "sse": {"description": "Server-Sent Events"},
            "websocket_streaming": {"description": "WebSocket streaming"},
            "mcp": {"description": "MCP"},
            "a2a": {"description": "A2A"},
            "anp": {"description": "ANP"},
            "acp": {"description": "ACP"},
    ...
    "format": {
        ...
        "values": {
            ...
            "protobuf": {"description": "Protocol Buffers"},
            "avro": {"description": "Avro"},
    ...
    "status_code": {
        ...
        "values": {
            "1xx_informational": {"description": "1xx Informational"},
            "2xx_success": {"description": "2xx Success"},
            "3xx_redirect": {"description": "3xx Redirection"},
            "4xx_client_error": {"description": "4xx Client Error"},
            "5xx_server_error": {"description": "5xx Server Error"},
            "200": {"description": "OK"},
    ...
    "intent": {
        ...
        "values": {
            "informational": {"description": "Get information"},
            "transactional": {"description": "Complete transaction"},
            "navigation": {"description": "Navigate to page"},
            "search": {"description": "Search"},
            "support": {"description": "Get support"},
            "feedback": {"description": "Leave feedback"},
            "complaint": {"description": "File complaint"},
            "enquiry": {"description": "Make enquiry"},
            "booking": {"description": "Make booking"},
            "subscription": {"description": "Subscribe"},
        }
    },
    "sentiment": {
        "name": "Sentiment",
